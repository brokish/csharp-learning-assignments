...
public static class TemperatureCalculator
{
    public static void ReturnCorrectTemperature()
    {
        ...
        var temperatureInCelsius = Console.ReadLine().ToUpper();
        ...
        if (temperatureInCelsius == "C")
        {
            ...
            var doubleInput = SharedUtils.ParseStringToDouble(Console.ReadLine());
